...
def train_yolo():
    # 載入預訓練模型
    model = YOLO("D:\\USER\\Desktop\\product_train_last3085\\runs\\detect\\shelf_finetune_v26_v1_add_2000_yolo11n_finetune_100\\weights\\best.pt")
    ...
    results = model.train(
        ...
        imgsz=640,             # 圖片輸入大小
        batch=16,              # Batch size
        name="shelf_finetune_v26_v1_add_2000_yolo11n_600_advanced_finetune_with_100", # 輸出結果資料夾名
